...
INSERT INTO `tbl_akses` (`id_akses`, `id_user`, `id_menu`) VALUES
(1, 731, 1),
(2, 731, 6),
(3, 731, 2),
(4, 731, 7),
...
INSERT INTO `tbl_barang` (`barang_id`, `barang_nama`, `barang_satuan`, `barang_harpok`, `barang_harjul`, `barang_harjul_grosir`, `barang_stok`, `barang_min_stok`, `barang_tgl_input`, `barang_tgl_last_update`, `barang_kategori_id`, `created_by`) VALUES
('BR000001', 'Klem Kabel IKK No 7', 'Bks', 15000, 20000, 17000, 0, 1, '2016-11-22 23:30:50', NULL, 11, '1'),
('BR000002', 'Klem Kabel IKK No 8', 'Bks', 16000, 20000, 18000, 0, 1, '2016-11-22 23:32:02', NULL, 11, '1'),
...
('BR000005', 'Klem kabel dms No 6', 'Bks', 3000, 5000, 4000, 1, 1, '2016-11-22 23:35:23', NULL, 10, '1'),
...
('BR000031', 'MCB Sheineder 25A SNI', 'PCS', 47500, 70000, 55000, 1, 1, '2016-11-23 00:23:18', NULL, 7, '1'),
...
('BR000043', 'Saklar Engkel Omi KK', 'PCS', 4500, 10000, 6000, 2, 1, '2016-11-23 00:52:21', '2016-11-29 14:35:29', 5, '1'),
...
('BR000054', 'Antena Remot Misonic 850', 'PCS', 87500, 120000, 100000, 1, 1, '2016-11-23 16:51:12', NULL, 13, '1'),
...
('BR000059', 'Antena Digital HD 5000', 'PCS', 106000, 145000, 120000, 10, 1, '2016-11-23 16:55:35', NULL, 13, '1'),
...
('BR000255', 'test b', 'Bks', 220000, 200000, 190000, 23, 1, '2022-02-27 09:09:27', '2022-02-27 16:09:27', 6, 'sani');
...
(1, '200222000001', 'BR000003', 'Klem Kabel IKK No 9', 'Bks', 16000, 22000, 1, 0, 22000),
(2, '200222000001', 'BR000021', 'Stop Kontak Fonic KK', 'PCS', 8750, 12000, 1, 0, 12000),
(3, '200222000002', 'BR000009', 'Klem kabel dms No 10', 'Bks', 5000, 9000, 1, 0, 9000),
(4, '200222000003', 'BR000001', 'Klem Kabel IKK No 7', 'Bks', 15000, 20000, 1, 0, 20000),
(5, '200222000004', 'BR000002', 'Klem Kabel IKK No 8', 'Bks', 16000, 20000, 1, 0, 20000),
(6, '200222000005', 'BR000005', 'Klem kabel dms No 6', 'Bks', 3000, 5000, 1, 0, 5000),
(7, '200222000005', 'BR000043', 'Saklar Engkel Omi KK', 'PCS', 4500, 10000, 3, 0, 30000),
(8, '200222000006', 'BR000031', 'MCB Sheineder 25A SNI', 'PCS', 47500, 70000, 1, 0, 70000),
(9, '200222000006', 'BR000002', 'Klem Kabel IKK No 8', 'Bks', 16000, 20000, 1, 0, 20000),
(10, '200222000006', 'BR000021', 'Stop Kontak Fonic KK', 'PCS', 8750, 12000, 2, 0, 24000),
(11, '200222000007', 'BR000004', 'Klem Kabel IKK No 10', 'Bks', 17000, 24000, 1, 0, 24000),
(12, '220222000001', 'BR000012', 'Klem kabel Steel No 8', 'Bks', 4200, 8000, 1, 0, 8000),
(13, '270222000001', 'BR000255', 'test b', 'Bks', 220000, 200000, 1, 20000, 180000);
...
('200222000001', '2022-02-20 08:23:49', 34000, 100000, 66000, 0, 'eceran'),
('200222000002', '2022-02-20 08:30:31', 9000, 100000, 91000, 0, 'eceran'),
('200222000003', '2022-02-20 08:31:13', 20000, 100000, 80000, 0, 'eceran'),
('200222000004', '2022-02-20 08:32:31', 20000, 100000, 80000, 0, 'eceran'),
('200222000005', '2022-02-20 08:37:43', 35000, 50000, 15000, 0, 'eceran'),
('200222000006', '2022-02-20 08:50:58', 114000, 200000, 86000, 0, 'eceran'),
('200222000007', '2022-02-20 09:59:24', 24000, 100000, 76000, 0, 'eceran'),
('220222000001', '2022-02-22 08:58:01', 8000, 20000, 12000, 0, 'eceran'),
('270222000001', '2022-02-27 10:43:05', 180000, 200000, 20000, 0, 'eceran');
...
INSERT INTO `tbl_menu` (`id_menu`, `id_kategori`, `nama_menu`, `label_menu`, `image`) VALUES
(1, 1, 'psnsale', 'Sales', 'pos.png'),
(2, 1, 'reportpos', 'Report', 'report.png'),
(3, 3, 'index', 'Accounting', 'accounting.png'),
(6, 1, 'masteritem', 'Master item', 'masterdata.png'),
(8, 1, 'return', 'Return', 'return.png'),
(9, 1, 'pos_grosir', 'POS Grosir', 'posgrosir.png');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_menu_katagori`
--

CREATE TABLE `tbl_menu_katagori` (
  `id_menu_katagori` int(11) NOT NULL,
  `nama_katagori` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_menu_katagori`
--

INSERT INTO `tbl_menu_katagori` (`id_menu_katagori`, `nama_katagori`) VALUES
(1, 'POS'),
(2, 'Accounting'),
(3, 'Purchasing'),
(4, 'Gudang'),
...
--
-- Table structure for table `tbl_trans_saleskasir_detail`
--

CREATE TABLE `tbl_trans_saleskasir_detail` (
  `id` int(11) NOT NULL,
  `id_trans_saleskasir_master` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_trans_saleskasir_master`
--

CREATE TABLE `tbl_trans_saleskasir_master` (
  `id` int(11) NOT NULL,
  ...
  `kredit_bayar` double NOT NULL,
  `kartu_debet` varchar(100) NOT NULL,
  `kartu_kredit` varchar(100) NOT NULL,
  `e-money` varchar(100) NOT NULL,
...
INSERT INTO `tbl_user` (`id`, `fullname`, `username`, `email_user`, `password`, `gender`, `dept`, `level`, `aktif`, `approver`, `ttd`, `ttd_name`, `created_by`, `created_date`) VALUES
(730, 'Asep Munawir', 'iwenk', 'iwenk@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '2', 'User', 1, 0, '', 'iwenk', 'sani', '2021-10-25 13:31:20'),
(731, 'Rizkisani', 'sani', 'rizkisani@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '2', 'Admin', 1, 0, '', 'sani', 'sani', '2021-11-06 15:03:00'),
(732, 'Ulfa Maryon', 'ulfa', 'ulfa@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '2', 'User', 1, 1, '', 'ulfa', 'sani', '2021-10-25 13:31:20'),
(733, 'Edwan Manggara', 'edwan', 'edwan@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '1', 'User', 1, 1, '', 'edwan', 'sani', '2021-10-19 05:46:32'),
(734, 'Sylvia Noorwenda', 'sylvia', 'sylvia@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '9', 'User', 1, 1, '', 'sylvia', 'sani', '2021-10-27 09:02:35'),
(736, 'Gilang', 'gilang', 'gilang@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '1', 'User', 1, 0, '', 'gilang', 'sani', '2021-11-16 08:16:36'),
(737, 'Lyemoy Sinaga', 'lyemoy', 'lyemoy@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '1', 'User', 0, 0, '', 'lyemoy', 'sani', '2021-11-16 08:17:27'),
(738, 'Susilo', 'susilo', 'susilo@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '10', 'Finance', 1, 0, '', 'susilo', 'sani', '2021-11-16 14:35:27'),
(739, 'Sport Station', 'sportstation', '123@gmail.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Male', '9', 'User', 1, 0, '', 'sportstation', 'sani', '2022-01-10 09:13:21'),
(740, 'Pamela', 'pamela', 'pamela@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '10', 'Finance', 1, 1, '', 'pamela', 'sani', '2022-01-14 16:32:14'),
(741, 'Tantri Kusumawati', 'tantri', 'tantri@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '11', 'User', 1, 0, '', 'tantri', 'sani', '2022-01-18 09:10:30'),
(742, 'Yunia Mulaebary', 'yunia', 'ymulaebary@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '11', 'User', 1, 1, '', 'yunia', 'sani', '2022-01-18 09:11:11'),
(743, 'Tantri Kusumawati', 'tantri', 'tantri@transstudiomall.co', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '3', 'User', 1, 0, '', 'tantri', 'sani', '2022-01-30 09:03:04'),
(744, 'Yunia Mulaebary', 'yunia', 'ymulaebary@transstudiomall.com', '5360f3da5dfbe3895b435da5b8dffe0e0639ea8c', 'Female', '3', 'User', 1, 1, '', 'yunia', 'sani', '2022-02-08 08:48:39');
...
--
-- Indexes for table `tbl_menu_katagori`
--
ALTER TABLE `tbl_menu_katagori`
  ADD PRIMARY KEY (`id_menu_katagori`);
...
--
-- Indexes for table `tbl_trans_saleskasir_detail`
--
ALTER TABLE `tbl_trans_saleskasir_detail`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_trans_saleskasir_master`
--
ALTER TABLE `tbl_trans_saleskasir_master`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_detail_jual`
  MODIFY `d_jual_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- AUTO_INCREMENT for table `tbl_menu_katagori`
--
ALTER TABLE `tbl_menu_katagori`
  MODIFY `id_menu_katagori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `tbl_trans_saleskasir_detail`
--
ALTER TABLE `tbl_trans_saleskasir_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_trans_saleskasir_master`
--
ALTER TABLE `tbl_trans_saleskasir_master`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
